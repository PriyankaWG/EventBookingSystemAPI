...
from schemas import AccountSchema, PerformerSchema, PlainPerformerSchema
from db import db
...
@blp.route("/organisers/performers")

class PerformerList(MethodView):

    @blp.response(200,PlainPerformerSchema(many=True))
    def get(self):
        return PerformersModel.query.all()
